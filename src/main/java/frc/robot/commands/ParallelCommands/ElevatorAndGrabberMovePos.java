...
public class ElevatorAndGrabberMovePos extends ParallelCommandGroup {
  /** Creates a new MatchElevatorAndGrabber. */
  public ElevatorAndGrabberMovePos(GrabberPlacement place, stateLevel level) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new GrabberMovePos(place), new ElevatorMovePos(level));
  }
}
