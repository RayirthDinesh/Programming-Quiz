...
public class RobotContainer {
  ...
  public static JoystickButton m_IntakeButton = new JoystickButton(driverJoystick, 1);
  public static JoystickButton m_OuttakeButton = new JoystickButton(driverJoystick, 12);
  public static JoystickButton zeroGyro = new JoystickButton(driverJoystick, 10);
  public static boolean encoderJoymodeState = false; 
  ...
  private void configureBindings() {
    ...
    // encoderJoymode.onTrue(new SwerveEncoderJoymode());
